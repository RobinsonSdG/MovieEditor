...
chemin_intro = "videos/030124.mp4"
chemin_generique = "videos/WithNewLogo.mp4"
chemin_principale = "videos/030124.mp4"

chemin_voix = "musics/030124.wav"
...
video_intro = VideoFileClip(chemin_intro).subclip(0,17.2).fx(vfx.fadeout, 1)
...
video_principale = video_principale.subclip(17.7,video_principale.duration)
...
video_finale.write_videofile("finale030124.mp4")